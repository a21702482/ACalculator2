...
class CalculatorFragment : Fragment(), onDisplayChanged
{
    ...
    fun onClickHistorico(view: View) {
        NavigationManager.goToHistoryFragment(this.fragmentManager!!)
    ...
    @OnClick(R.id.button_0, R.id.button_00, R.id.button_1, R.id.button_2,R.id.button_3,R.id.button_4,R.id.button_5,R.id.button_6,
        R.id.button_7,R.id.button_8,R.id.button_9,R.id.button_add,R.id.button_divide,R.id.button_sub,R.id.button_multi,R.id.button_point)
